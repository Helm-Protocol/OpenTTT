...
class TurnkeySDKClientBase {
    constructor(config) {
        ...
        if (config.defaultStamperType) {
            ...
            if (this.apiKeyStamper) {
                this.defaultStamperType = enums.StamperType.ApiKey;
            }
            else if (this.passkeyStamper) {
                this.defaultStamperType = enums.StamperType.Passkey;
            }
    ...
    getStamper(stampWith) {
        ...
        switch (stampWith) {
            case enums.StamperType.ApiKey:
                return this.apiKeyStamper;
            case enums.StamperType.Passkey:
