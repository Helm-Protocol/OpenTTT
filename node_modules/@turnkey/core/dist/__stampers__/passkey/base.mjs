import { generateRandomBuffer, isWeb, isReactNative } from '../../utils.mjs';
import { WebauthnStamper } from '@turnkey/webauthn-stamper';
import { base64StringToBase64UrlEncodedString, uint8ArrayToHexString } from '@turnkey/encoding';
...
class CrossPlatformPasskeyStamper {
    constructor(config) {
        ...
        this.createWebPasskey = async (config = {}) => {
            ...
            const encodedChallenge = base64StringToBase64UrlEncodedString(btoa(String.fromCharCode(...new Uint8Array(challenge))));
    ...
    async init() {
        if (isWeb()) {
            const { default: WindowWrapper } = await import('../../__polyfills__/window.mjs');
            ...
            try {
                ...
                this.stamper = new PasskeyStamper({
                    ...
                    allowCredentials: this.config.allowCredentials?.map((cred) => ({
                        id: uint8ArrayToHexString(cred.id),
                        type: cred.type,
...
export { CrossPlatformPasskeyStamper };
