...
import { uint8ArrayFromHexString, uint8ArrayToHexString, bs58 } from '@turnkey/encoding';
import { SignIntent, WalletInterfaceType, Chain } from '../../../__types__/enums.mjs';
import { withTimeoutFallback } from '../../../utils.mjs';
    ...
    constructor() {
        ...
        this.getProviders = async () => {
            ...
            await Promise.all(providers.map(async (wallet) => {
                ...
                const connectedAddresses = await withTimeoutFallback((async () => {
                    try {
