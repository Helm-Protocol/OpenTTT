...
import { WalletInterfaceType, Chain } from '../../__types__/enums.mjs';
...
class WebWalletManager {
    ...
    constructor(cfg) {
        ...
        if (cfg.walletConnect && enableWalletConnect) {
            ...
            const wcUnified = new WalletConnectWallet(this.wcClient, () => this.ensureWalletConnectReady(), { ethereumNamespaces, solanaNamespaces });
            this.wallets[WalletInterfaceType.WalletConnect] = wcUnified;
            // add async init step to the initializer queue
            this.initializers.push(() => withTimeout(wcUnified.init(), 15000, "WalletConnect wallet").catch((err) => {
