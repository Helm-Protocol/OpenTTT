import { uint8ArrayFromHexString, stringToBase64urlString, uint8ArrayToHexString, bs58 } from '@turnkey/encoding';
import { toHex, recoverPublicKey, hashMessage } from 'viem';
import { compressRawPublicKey } from '@turnkey/crypto';
import { WalletInterfaceType, Chain, SignIntent } from '../../__types__/enums.mjs';
