...
import type { v1ApiKeyCurve, v1Attestation, v1OauthProviderParams, v1WalletAccountParams } from "@turnkey/sdk-types";
/** @internal */
...
export interface ApiKeyStamperBase {
    ...
    sign(payload: string, publicKeyHex: string, format?: SignatureFormat): Promise<string>;
}
/** @internal */
export type Passkey = {
