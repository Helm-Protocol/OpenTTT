 ...
 */
import type { v1AddressFormat, v1Attestation, v1CreatePolicyIntentV3, v1HashFunction, v1Pagination, v1PayloadEncoding, v1TransactionType, v1WalletAccountParams, v1AppProof } from "@turnkey/sdk-types";
import type { CreateSubOrgParams, OtpType, StamperType, SwitchableChain, WalletAccount, WalletProvider, Wallet, TSignedRequest } from "../index";
...
export type ClearSessionParams = {
    sessionKey?: string;
};
