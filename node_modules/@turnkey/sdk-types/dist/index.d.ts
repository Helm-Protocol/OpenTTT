...
export declare enum TurnkeyErrorCodes {
    ...
    WALLET_BUILD_LOGIN_REQUEST_ERROR = "WALLET_BUILD_LOGIN_REQUEST_ERROR",
    ...
    SOL_SEND_TRANSACTION_ERROR = "SOL_SEND_TRANSACTION_ERROR",
...
export declare class TurnkeyError extends Error {
    code?: TurnkeyErrorCodes | undefined;
    cause?: unknown;
    constructor(message: string, code?: TurnkeyErrorCodes | undefined, cause?: unknown);
}
export declare class TurnkeyNetworkError extends TurnkeyError {
    statusCode?: number | undefined;
    constructor(message: string, statusCode?: number | undefined, code?: TurnkeyErrorCodes, cause?: unknown);
}
export declare enum FiatOnRampProvider {
    COINBASE = "FIAT_ON_RAMP_PROVIDER_COINBASE",
    MOONPAY = "FIAT_ON_RAMP_PROVIDER_MOONPAY"
}
export declare enum FiatOnRampCryptoCurrency {
...
export declare enum FiatOnRampCurrency {
    ...
    ZAR = "FIAT_ON_RAMP_CURRENCY_ZAR"
}
export declare enum FiatOnRampBlockchainNetwork {
    ...
    BASE = "FIAT_ON_RAMP_BLOCKCHAIN_NETWORK_BASE"
}
export declare enum FiatOnRampPaymentMethod {
    ...
    ACH_BANK_ACCOUNT = "FIAT_ON_RAMP_PAYMENT_METHOD_ACH_BANK_ACCOUNT"
}
