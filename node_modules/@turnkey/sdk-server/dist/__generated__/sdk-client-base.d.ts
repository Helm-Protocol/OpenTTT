...
export declare class TurnkeySDKClientBase {
    ...
    getBootProof: (input: SdkApiTypes.TGetBootProofBody) => Promise<SdkApiTypes.TGetBootProofResponse>;
    stampGetBootProof: (input: SdkApiTypes.TGetBootProofBody) => Promise<TSignedRequest | undefined>;
    getGasUsage: (input: SdkApiTypes.TGetGasUsageBody) => Promise<SdkApiTypes.TGetGasUsageResponse>;
    stampGetGasUsage: (input: SdkApiTypes.TGetGasUsageBody) => Promise<TSignedRequest | undefined>;
    getLatestBootProof: (input: SdkApiTypes.TGetLatestBootProofBody) => Promise<SdkApiTypes.TGetLatestBootProofResponse>;
    stampGetLatestBootProof: (input: SdkApiTypes.TGetLatestBootProofBody) => Promise<TSignedRequest | undefined>;
    getNonces: (input: SdkApiTypes.TGetNoncesBody) => Promise<SdkApiTypes.TGetNoncesResponse>;
    stampGetNonces: (input: SdkApiTypes.TGetNoncesBody) => Promise<TSignedRequest | undefined>;
    getOauth2Credential: (input: SdkApiTypes.TGetOauth2CredentialBody) => Promise<SdkApiTypes.TGetOauth2CredentialResponse>;
    stampGetOauth2Credential: (input: SdkApiTypes.TGetOauth2CredentialBody) => Promise<TSignedRequest | undefined>;
    ...
    getOnRampTransactionStatus: (input: SdkApiTypes.TGetOnRampTransactionStatusBody) => Promise<SdkApiTypes.TGetOnRampTransactionStatusResponse>;
    stampGetOnRampTransactionStatus: (input: SdkApiTypes.TGetOnRampTransactionStatusBody) => Promise<TSignedRequest | undefined>;
    ...
    getSendTransactionStatus: (input: SdkApiTypes.TGetSendTransactionStatusBody) => Promise<SdkApiTypes.TGetSendTransactionStatusResponse>;
    stampGetSendTransactionStatus: (input: SdkApiTypes.TGetSendTransactionStatusBody) => Promise<TSignedRequest | undefined>;
    ...
    getWalletAddressBalances: (input: SdkApiTypes.TGetWalletAddressBalancesBody) => Promise<SdkApiTypes.TGetWalletAddressBalancesResponse>;
    stampGetWalletAddressBalances: (input: SdkApiTypes.TGetWalletAddressBalancesBody) => Promise<TSignedRequest | undefined>;
    ...
    getAppProofs: (input: SdkApiTypes.TGetAppProofsBody) => Promise<SdkApiTypes.TGetAppProofsResponse>;
    stampGetAppProofs: (input: SdkApiTypes.TGetAppProofsBody) => Promise<TSignedRequest | undefined>;
    listFiatOnRampCredentials: (input: SdkApiTypes.TListFiatOnRampCredentialsBody) => Promise<SdkApiTypes.TListFiatOnRampCredentialsResponse>;
    stampListFiatOnRampCredentials: (input: SdkApiTypes.TListFiatOnRampCredentialsBody) => Promise<TSignedRequest | undefined>;
    listOauth2Credentials: (input: SdkApiTypes.TListOauth2CredentialsBody) => Promise<SdkApiTypes.TListOauth2CredentialsResponse>;
    stampListOauth2Credentials: (input: SdkApiTypes.TListOauth2CredentialsBody) => Promise<TSignedRequest | undefined>;
    ...
    listSupportedAssets: (input: SdkApiTypes.TListSupportedAssetsBody) => Promise<SdkApiTypes.TListSupportedAssetsResponse>;
    stampListSupportedAssets: (input: SdkApiTypes.TListSupportedAssetsBody) => Promise<TSignedRequest | undefined>;
    ...
    createFiatOnRampCredential: (input: SdkApiTypes.TCreateFiatOnRampCredentialBody) => Promise<SdkApiTypes.TCreateFiatOnRampCredentialResponse>;
    stampCreateFiatOnRampCredential: (input: SdkApiTypes.TCreateFiatOnRampCredentialBody) => Promise<TSignedRequest | undefined>;
    ...
    createOauth2Credential: (input: SdkApiTypes.TCreateOauth2CredentialBody) => Promise<SdkApiTypes.TCreateOauth2CredentialResponse>;
    stampCreateOauth2Credential: (input: SdkApiTypes.TCreateOauth2CredentialBody) => Promise<TSignedRequest | undefined>;
    ...
    deleteFiatOnRampCredential: (input: SdkApiTypes.TDeleteFiatOnRampCredentialBody) => Promise<SdkApiTypes.TDeleteFiatOnRampCredentialResponse>;
    stampDeleteFiatOnRampCredential: (input: SdkApiTypes.TDeleteFiatOnRampCredentialBody) => Promise<TSignedRequest | undefined>;
    ...
    deleteOauth2Credential: (input: SdkApiTypes.TDeleteOauth2CredentialBody) => Promise<SdkApiTypes.TDeleteOauth2CredentialResponse>;
    stampDeleteOauth2Credential: (input: SdkApiTypes.TDeleteOauth2CredentialBody) => Promise<TSignedRequest | undefined>;
    ...
    deletePolicies: (input: SdkApiTypes.TDeletePoliciesBody) => Promise<SdkApiTypes.TDeletePoliciesResponse>;
    stampDeletePolicies: (input: SdkApiTypes.TDeletePoliciesBody) => Promise<TSignedRequest | undefined>;
    ...
    deleteWalletAccounts: (input: SdkApiTypes.TDeleteWalletAccountsBody) => Promise<SdkApiTypes.TDeleteWalletAccountsResponse>;
    stampDeleteWalletAccounts: (input: SdkApiTypes.TDeleteWalletAccountsBody) => Promise<TSignedRequest | undefined>;
    ...
    ethSendTransaction: (input: SdkApiTypes.TEthSendTransactionBody) => Promise<SdkApiTypes.TEthSendTransactionResponse>;
    stampEthSendTransaction: (input: SdkApiTypes.TEthSendTransactionBody) => Promise<TSignedRequest | undefined>;
    ...
    oauth2Authenticate: (input: SdkApiTypes.TOauth2AuthenticateBody) => Promise<SdkApiTypes.TOauth2AuthenticateResponse>;
    stampOauth2Authenticate: (input: SdkApiTypes.TOauth2AuthenticateBody) => Promise<TSignedRequest | undefined>;
    ...
    solSendTransaction: (input: SdkApiTypes.TSolSendTransactionBody) => Promise<SdkApiTypes.TSolSendTransactionResponse>;
    stampSolSendTransaction: (input: SdkApiTypes.TSolSendTransactionBody) => Promise<TSignedRequest | undefined>;
    ...
    updateFiatOnRampCredential: (input: SdkApiTypes.TUpdateFiatOnRampCredentialBody) => Promise<SdkApiTypes.TUpdateFiatOnRampCredentialResponse>;
    stampUpdateFiatOnRampCredential: (input: SdkApiTypes.TUpdateFiatOnRampCredentialBody) => Promise<TSignedRequest | undefined>;
    updateOauth2Credential: (input: SdkApiTypes.TUpdateOauth2CredentialBody) => Promise<SdkApiTypes.TUpdateOauth2CredentialResponse>;
    stampUpdateOauth2Credential: (input: SdkApiTypes.TUpdateOauth2CredentialBody) => Promise<TSignedRequest | undefined>;
